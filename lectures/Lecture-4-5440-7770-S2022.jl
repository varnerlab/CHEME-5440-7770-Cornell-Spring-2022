...
1. Introduce direct Gibbs energy minimization using the partial molar Gibbs energy
1. Compute the reversibility of a single enzyme-catalyzed reaction
"""
...
# ╔═╡ 3db609fc-0269-4208-9307-dd75229e3063
...
# ╔═╡ 8dc66d99-7a15-4aea-9805-77706246d77b
md"""
###### Method 1: Direct search of the Gibbs energy landscape
"""

# ╔═╡ 21718432-f5b5-4886-b04b-a00abfd451f4
begin
...
# ╔═╡ 2220acc0-e0b5-4aff-9e7e-0a15c356898d
begin
...
md"""
###### Method 2: Constrained nonlinear optimization problem
Let's recast the Gibbs energy estimation as a (nonlinear) _constrained_ optimization problem and solve this problem using the [Optim.jl](https://github.com/JuliaNLSolvers/Optim.jl) package. 
"""
...
1. Introduced direct Gibbs energy minimization using the partial molar Gibbs energy
1. Computed the reversibility of a single enzyme-catalyzed reaction
"""
