...
md"""
### Boolean models for choice functions

In this lecture, we'll begin our discussion of the various forms for the $u\left(\dots\right)$ and $w\left(\dots\right)$ control functions which describe gene expression choices cells make in response to changing conditions. In particular, 
we will
