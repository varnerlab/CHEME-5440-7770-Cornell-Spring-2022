...
function objective_function(κ, data_array, r_kl, W₁, W₂)
	...
	(number_of_data_points, NC) = size(data_array)
	error_array = zeros(number_of_data_points)
...
begin
	...
	with_terminal() do
		println("K₂ = $(nm_soln[1]) mM and n₂ = $(nm_soln[2]) dimensionless")
	end
end
