...
# ╔═╡ 123a2544-063b-4118-9273-cd256d56e797
md"""
### C2: Ignore dilution but include metabolite data in the bounds
"""

# ╔═╡ 7410b013-503f-48fb-a50e-c685216fd2f7
md"""
...
# ╔═╡ b3300fd2-538f-4f6b-97e8-f926614203de
PlutoUI.LocalResource(joinpath(_PATH_TO_FIGS,"Fig-Urea-cycle.png"))

# ╔═╡ e51f1fff-b869-4379-b99a-33318936e1c2
begin
...
# ╔═╡ 54d4ca84-7748-48b2-bf35-d15d9881477d
begin
...
begin
	...
	# v₁ - EC: 6.3.4.5 
	sat_term_array[1] = (11.9)*(96.7)/((1+11.9)*(1+96.7)) 
	...
	flux_bounds_array[1,2] = 203.0*E[1]*sat_term_array[1]
	flux_bounds_array[2,2] = 34.5*E[2]*sat_term_array[2]
	flux_bounds_array[3,2] = 249.0*E[3]*sat_term_array[3]
	flux_bounds_array[4,2] = 88.1*E[4]*sat_term_array[4]
	flux_bounds_array[5,2] = 13.7*E[5]*sat_term_array[5]
	flux_bounds_array[6,2] = 13.7*E[6]*sat_term_array[6]

	# setup flux bounds array -
	flux_bounds_array_nm = zeros(ℛ,2)
	flux_bounds_array_nm[:,2] .= 100.0 # default value is 100 for flux units: μmol/gDW-s
	flux_bounds_array_nm[1,2] = 203.0*E[1]
	flux_bounds_array_nm[2,2] = 34.5*E[2]
	flux_bounds_array_nm[3,2] = 249.0*E[3]
	flux_bounds_array_nm[4,2] = 88.1*E[4]
	flux_bounds_array_nm[5,2] = 13.7*E[5]
	flux_bounds_array_nm[6,2] = 13.7*E[6]

	# O2 uptake -
	flux_bounds_array[15,1] = 0.25
	flux_bounds_array_nm[15,1] = 0.25
	...
	result_case_2_nm = lib.flux(S,flux_bounds_array_nm,species_bounds_array,c_vector);
...
with_terminal() do
	...
	for i ∈ 1:N
		state_array[i,1] = i
		state_array[i,2] = flux_bounds_array_nm[i,2]
		state_array[i,3] = flux_bounds_array[i,2]
	end

	# setup header -
	header_data = (["i","Uᵢ w/no metabolite", "Uᵢ w/metabolite"],
...
# ╔═╡ db8a92d0-2637-4aea-aa05-dbe8b75df081
html"""
<script>
	// initialize -
	var section = 0;
